...
const char *wifi_ssid = "Tel de Laurent";
...
const char *client_id = "TD02_GP09";
...
void setup()
{
  ...
  {
    mqtt_client.publish("TD02_GP09/temp", String(temp_measure).c_str());
    mqtt_client.publish("TD02_GP09/relhum", String(relative_humidity_measure).c_str());
  }
